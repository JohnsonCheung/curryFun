...
export declare const where: <A>(p: pred<A>) => (a: Iterable<any>) => A[];
export declare const map: <A, B>(f: (a: A, i?: number | undefined) => B) => (a: Iterable<any>) => B[];
export declare const each: (f: (a: any, i?: number | undefined) => void) => (a: Iterable<any>) => void;
export declare const mapKy: (_map: Map<any, any>) => any[];
export declare const mapVy: (_map: Map<any, any>) => any[];
export declare const mapKvy: (_map: Map<any, any>) => [any, any][];
export declare const mapKset: (_map: Map<any, any>) => Set<any>;
...
export declare const linLasTerm: (a: string) => string;
export declare const linT2: (a: string) => string;
export declare const linShift: (a: string) => {
    term: string;
    remainLin: string;
};
export declare const sRmvFstTerm: (a: string) => string;
...
export declare const lyRmvEmpLin: (_ly: string[]) => string[];
export declare const lyPfxCnt: (pfx: string) => (a: string[]) => number;
export declare const lyHasMajPfx: (pfx: string) => (a: string[]) => boolean;
export declare const reExpConstNm: RegExp;
export declare const reConstNm: RegExp;
...
export declare const itrLas: <T>(a: Iterable<T>) => any;
...
export declare const vvCompare: (a: any, b: any) => 1 | -1 | 0;
...
export declare const sBrwAtFdrFn: (_fdr: string, _fn: string) => (_s: string) => void;
export declare const oBrwAtFdrFn: (_fdr: string, _fn: string) => (_o: any) => void;
...
export declare const dicKy: <T>(_dic: Map<string, T>) => string[];
export declare const dicValAy: <T>(_dic: Map<string, T>) => T[];
export declare const sdicValAy: (_sdic: Map<string, string>) => string[];
export declare const dicBrkForTrueFalse: <V>(fun: ([s, V]: [any, any]) => boolean) => (d: Map<string, V>) => tfPair<Map<string, V>>;
export declare const dicBrw: <T>(a: Map<string, T>) => void;
export declare const oJsonLines: (a: object) => string;
export declare const oAsExp: (o: any) => string;
...
export declare const oBrw: (a: any) => void;
export declare const oBrwAsExp: (a: object) => void;
...
export declare const ssetAddPfxAsLin: (pfx: any) => (set: any) => string;
