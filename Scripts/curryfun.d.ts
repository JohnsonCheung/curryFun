...
export declare const sdicSy: (a: Map<string, string>) => string[];
export declare const ksLin: ({ k, s }: ks) => string;
...
export declare const lyReDry: (re: RegExp) => (a: string[]) => any[][];
export declare const lyReCol: (re: RegExp) => (a: string[]) => any[];
export declare const matchAySdry: (a: RegExpMatchArray[]) => any[][];
export declare const matchFstItm: (a: RegExpMatchArray) => string;
export declare const matchAyFstCol: (a: RegExpMatchArray[]) => any[];
export declare const lyPfxCnt: (pfx: string) => (a: string[]) => number;
export declare const lyHasMajPfx: (pfx: string) => (a: string[]) => boolean;
export declare const lyMatchAy: (re: RegExp) => (a: string[]) => RegExpMatchArray[];
export declare const matchDr: (a: RegExpMatchArray) => string[];
export declare const reExpConstNm: RegExp;
export declare const reExpDollarConstNm: RegExp;
export declare const lyExpConstNy: (a: string[]) => string[];
export declare const lyExpConstDollarNy: (a: string[]) => string[];
...
export declare const isDte: (a: {}) => boolean;
export declare const isFun: (a: {}) => boolean;
...
export declare const drySdry: (a: any[][]) => string[][];
...
export declare const entryStatPm: (a: any) => Promise<void>;
export declare const pthFnAyPm: (a: string, lik?: string | undefined) => Promise<string[]>;
export declare const pthStatAyPm: (a: string, lik?: string | undefined) => Promise<void>;
...
export declare const lyExpStmt: (a: string[]) => string | null;
...
export declare const cmdShell: (a: string) => child_process.ChildProcess;
export declare const ftBrw: (a: string) => child_process.ChildProcess;
...
export declare const chrCd_isFstNmChr: p;
...
export declare const mdSet: () => Set<NodeModule>;
