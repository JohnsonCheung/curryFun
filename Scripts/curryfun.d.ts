...
export declare type _dryWdtAy = (a: dry) => wdt[];
export declare type _dryWdt = (colIx: n) => (a: dry) => wdt;
...
export declare const sBrkP123: (quoteStr: string) => (a: string) => {
    p1: string;
    p2: string;
    p3: string;
} | null;
...
export declare const dryColWdt: _dryWdt;
export declare const dryColWdtAy: _dryWdtAy;
export declare const dryCol: _dryCol;
export declare const dryColCnt: _dryCnt;
export declare const dryCellMdy: _dryCellMdy;
...
export declare const oLines: (o: any) => string;
